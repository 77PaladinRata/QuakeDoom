...
public class EnemyFollow : Enemy ///*MonoBehaviour ///*Agregando Enemy
{
    [SerializeField]
    ...
    {                           ///* Agregando el nombre de sonido
        SoundManager. instance.Play("Takopi_damage"); ///* Daño
    ...
    public void Die()
    {
        ...
        SoundManager.instance.Play("Takopi_die"); ///* muere el enemigo
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {                                          ///* muere el enemigo
            SoundManager.instance.Play("cacodemon_attack"); ///* Ataque
