...
public class EnemyKnight : Enemy
{
    ...
    {
        SoundManager.instance.Play ("Knight_Appear");   ///* Sonido APARCER ********
        base.OnEnable();
    ...
    {
        SoundManager.instance.Play("Knight_Attack");    ///* Sonido ATAQUE*****Motocierra_Attack***
...
player.GetComponent<Player>().PushBack(transform, 5f);
    ...
    public override void Die()
    {
        ...
        rb.isKinematic= true;
        SoundManager.instance.Play("Knight_Death");   ///* Sonido MUERE********
        base.Die();
